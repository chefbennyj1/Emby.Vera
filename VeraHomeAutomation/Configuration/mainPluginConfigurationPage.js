    ...
    function (loading, dialogHelper) {
        ...
        function svgIcon(device, appName) {
            ...
            if (appName.toLowerCase().indexOf("dlna") > -1 ||
                device.ToLtoLowerCasewer().indexOf("dlna") > -1)
